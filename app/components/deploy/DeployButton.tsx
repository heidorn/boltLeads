    ...
    <>
      <div className="flex border border-bolt-elements-borderColor rounded-md overflow-hidden text-sm">
        <DropdownMenu.Root>
          ...
          >
            {isDeploying ? `Fazendo deploy em ${deployingTo}…` : 'Deploy'}
          ...
          >
            ...
            >
              ...
              <span className="mx-auto">
                {!netlifyConn.user ? 'Nenhuma conta Netlify conectada' : 'Deploy no Netlify'}
              </span>
            ...
            >
              ...
              />
              <span className="mx-auto">
                {!vercelConn.user ? 'Nenhuma conta Vercel conectada' : 'Deploy no Vercel'}
              </span>
            ...
            >
              <img
                ...
                alt="github"
              />
              <span className="mx-auto">Deploy no GitHub</span>
            </DropdownMenu.Item>
            ...
            >
              ...
              />
              <span className="mx-auto">
                {!gitlabIsConnected ? 'Nenhuma conta GitLab conectada' : 'Deploy no GitLab'}
              </span>
            </DropdownMenu.Item>
            ...
            >
              <img
                ...
                alt="cloudflare"
              />
              <span className="mx-auto">Deploy na Cloudflare (em breve)</span>
            </DropdownMenu.Item>
          </DropdownMenu.Content>
        </DropdownMenu.Root>
      </div>
