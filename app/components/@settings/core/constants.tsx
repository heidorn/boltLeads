...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  profile: 'Seu perfil e as informações da conta',
  settings: 'Preferências do Studio',
  notifications: 'Suas notificações',
  features: 'Recursos novos e experimentais',
  data: 'Seus dados e armazenamento local',
  'cloud-providers': 'Chaves e modelos dos provedores em nuvem',
  'local-providers': 'Modelos rodando na sua máquina',
  github: 'Conexão com o GitHub',
  gitlab: 'Conexão com o GitLab',
  netlify: 'Publicação no Netlify',
  vercel: 'Projetos e deploys no Vercel',
  supabase: 'Conexão com o banco Supabase',
  'event-logs': 'Eventos e registros do sistema',
