  ...
  if (!isConnected || !connection) {
    return (
      <div className="text-center p-8">
        <p className="text-bolt-elements-textSecondary mb-4">Conecte-se ao GitHub para navegar pelos repositórios</p>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <option value="forks">Repositórios fork</option>
            <option value="archived">Repositórios arquivados</option>
          </select>
        </div>
      </div>
