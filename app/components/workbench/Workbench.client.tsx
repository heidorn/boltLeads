                      ...
                      {filteredFiles.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center p-4 text-center">
                          ...
                          <p className="text-sm font-medium text-bolt-elements-textPrimary">
                            {searchQuery ? 'Nenhum arquivo encontrado' : 'Nenhum arquivo alterado'}
                          </p>
                          <p className="text-xs text-bolt-elements-textTertiary mt-1">
                            {searchQuery
                              ? 'Tente outro termo de busca'
                              : 'As alterações aparecem aqui conforme você edita'}
                          </p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="border-t border-bolt-elements-borderColor p-2">
                      <button
                        onClick={() => {
                          ...
                          toast('Lista de arquivos copiada', {
  ...
  ({
    ...
    const onFileSave = useCallback(() => {
      workbenchStore
        ...
        .catch(() => {
          toast.error('Não foi possível atualizar o conteúdo do arquivo');
        });
    }, []);
    ...
    const handleSyncFiles = useCallback(async () => {
      ...
      try {
        ...
        toast.error('Não foi possível sincronizar os arquivos');
      } finally {
        setIsSyncing(false);
      }
    }, []);
    ...
    return (
      chatStarted && (
        <>
          <ChatResizeHandle visible={showWorkbench && showChat && !isSmallViewport} />

          {/*
           * `shrink-0`: sem isto o flex roubava largura do painel para acomodar a largura
           * mínima do conteúdo do chat, e a coluna terminava maior que `--chat-min-width` —
           * era daí que vinha o desencontro com o painel, que é `fixed` e mede pela janela.
           */}
          <motion.div
            initial="closed"
              ...
              <div className="absolute inset-0 px-2 lg:px-4">
                <div className="h-full flex flex-col bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor shadow-sm rounded-lg overflow-hidden">
                  <div className="flex items-center px-3 py-2 border-b border-bolt-elements-borderColor gap-1.5">
                    ...
                    {/*
                     * O X de fechar saiu: uma vez fechado, não havia nada na interface
                     * que trouxesse o workbench de volta — só um novo artefato do assistente.
                     * Fechar sem poder reabrir é um beco, não um controle.
                     */}
                  </div>
